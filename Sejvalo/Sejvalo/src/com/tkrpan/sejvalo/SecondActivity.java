...
public class SecondActivity extends SherlockActivity implements
		OnClickListener, OnItemSelectedListener, OnScrollListener,
		OnItemClickListener, OnDownloadCompletedInterface, OnTouchListener {
	...
	public void onClick(View v) {
		...
		case R.id.buttonRefine: // ***********Prebaciti na fragment
								// kasnije***********
